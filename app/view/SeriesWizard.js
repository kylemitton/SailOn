...
Ext.define('DynaMightMobile.view.SeriesWizard', {
    ...
    onSeriesSelectChange: function(selectfield, newValue, oldValue, eOpts) {
        selectfield.setAutoSelect(null);
    },
    ...
    initialize: function() {
        ...
        divisionStore.execConfig({
            params: {
                ...
                //filters: ''
                filters: 'WHERE cast(createddate as date) < curdate() order by createddate desc, name'
            }
        });
        ...
        //debugger;
        //divisionStore.sort('name', 'ASC');
        raceDivisionsStore.sort('name', 'ASC');
