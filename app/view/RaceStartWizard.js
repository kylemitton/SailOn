                                ...
                                items: [
                                    {
                                        ...
                                        itemTpl: Ext.create('Ext.XTemplate', 
                                            ...
                                            '',
                                            '{[GetTemplate(\'boat\', values)]}',
                                            '    <tpl if="this.compareDate(values.startdate)">',
                                            '        <div class="item">',
                                            '            <div class="vicinity">',
                                            '                <span style = "margin-right:5px;">Start time: {[this.DateFormat(values.startdate)]}</span>',
                                            '            </div>',
                                            '            <div class="name"><span style = "margin-right:5px;">Do not start</span></div>',
                                            '        </div>',
                                            '    </tpl>',
                                            {
                                                getSignOn: function(date) {
                                                ...
                                                DateFormat: function(date) {
                                                    return date ? Ext.Date.format(new Date(date), 'Y-m-d H:i:s') : '';
                                                }
                                            }
                                        )
                                    },
