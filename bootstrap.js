...
Ext.ClassManager.addNameAlternateMappings({
  "DynaMightMobile.controller.BoatCrew": [],
  "DynaMightMobile.controller.HandicapWizard": [],
  "DynaMightMobile.controller.Navigation": [],
  "DynaMightMobile.controller.RaceDuty": [],
  "DynaMightMobile.controller.RaceEditor": [],
  "DynaMightMobile.controller.RaceFinishWizard": [],
  "DynaMightMobile.controller.RaceMessage": [],
  "DynaMightMobile.controller.RacePortalWizard": [],
  "DynaMightMobile.controller.RaceResults": [],
  "DynaMightMobile.controller.RaceSignOffWizard": [],
  "DynaMightMobile.controller.RaceStartWizard": [],
  "DynaMightMobile.controller.RegistrationWizard": [],
  "DynaMightMobile.controller.SeriesWizard": [],
  "DynaMightMobile.controller.SkipperBoatList": [],
  "DynaMightMobile.controller.SkipperInformation": [],
  "DynaMightMobile.model.MyModel": [],
  "DynaMightMobile.override.data.Store": [],
  "DynaMightMobile.override.field.Text": [],
  "DynaMightMobile.view.BoatCrew": [],
  "DynaMightMobile.view.BoatDetails": [],
  "DynaMightMobile.view.BoatDetails1": [],
  "DynaMightMobile.view.Calendar": [],
  "DynaMightMobile.view.GenericList": [
    "genericlist"
  ],
  "DynaMightMobile.view.HandicapWizard": [],
  "DynaMightMobile.view.LogInFrm": [],
  "DynaMightMobile.view.Main": [],
  "DynaMightMobile.view.MainCt": [],
  "DynaMightMobile.view.MenuView": [],
  "DynaMightMobile.view.MyButton193": [],
  "DynaMightMobile.view.RFBoats": [],
  "DynaMightMobile.view.RFRace": [],
  "DynaMightMobile.view.RFReview": [],
  "DynaMightMobile.view.RaceDuty": [],
  "DynaMightMobile.view.RaceFinishWizard": [],
  "DynaMightMobile.view.RaceMessages": [],
  "DynaMightMobile.view.RacePortal": [],
  "DynaMightMobile.view.RaceResults": [],
  "DynaMightMobile.view.RaceStartWizard": [],
  "DynaMightMobile.view.RegistrationWizard": [],
  "DynaMightMobile.view.ResultsEditor": [],
  "DynaMightMobile.view.SW": [],
  "DynaMightMobile.view.SWD": [],
  "DynaMightMobile.view.SeriesWizard": [],
  "DynaMightMobile.view.SideMenu": [],
  "DynaMightMobile.view.SignOffWizard": [],
  "DynaMightMobile.view.SignOnWizard": [],
  "DynaMightMobile.view.SkipperBoatList": [],
  "DynaMightMobile.view.SkipperInformation": [],
  "DynaMightMobile.view.StartLineCt": [],
  "Event": [],
  ...
  "Ext.form.ux.touch.ColorPickerField": [],
  "Ext.fx.Animation": [],
  "Ext.fx.Easing": [],
  "Ext.fx.Runner": [],
  "Ext.fx.State": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "DynaMightMobile.view.SignOnWizard": [],
  "DynaMightMobile.view.SkipperBoatList": [
    "widget.SkipperBoatList"
  ],
  "DynaMightMobile.view.SkipperInformation": [
    "widget.skiperInforamtion"
  ],
  "DynaMightMobile.view.StartLineCt": [
    "widget.startlinect"
  ],
